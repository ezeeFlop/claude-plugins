...
| **neokanban** | [NeoKanban](https://kanban.sponge-theory.dev) task, project and board management — plus audio transcription with speaker diarization — directly from Claude Code. On enable, enter your instance URL and an `nk_mcp_…` token. |
